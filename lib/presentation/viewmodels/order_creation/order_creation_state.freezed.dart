...
part of 'order_creation_state.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is OrderCreationState);
}
...
/// @nodoc
class $OrderCreationStateCopyWith<$Res>  {
$OrderCreationStateCopyWith(OrderCreationState _, $Res Function(OrderCreationState) __);
}


/// Adds pattern-matching-related methods to [OrderCreationState].
extension OrderCreationStatePatterns on OrderCreationState {
...
class _Initial implements OrderCreationState {
  const _Initial();
...
@override
String toString() {
  return 'OrderCreationState.initial()';
}
...
class _Loading implements OrderCreationState {
  const _Loading();
...
@override
String toString() {
  return 'OrderCreationState.loading()';
}
...
class _Success implements OrderCreationState {
  const _Success();
...
@override
String toString() {
  return 'OrderCreationState.success()';
}
...
class _Error implements OrderCreationState {
...
@override
String toString() {
  return 'OrderCreationState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $OrderCreationStateCopyWith<$Res> {
